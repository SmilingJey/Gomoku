...
public class GomokuAlg {

    private final int cost_2 = 1;
    private final int cost_x1 = 3;
    private final int cost_x0 = 8;
    private final int cost_xx1 = 20;
    private final int cost_xx0 = 250;
    private final int cost_xxx1 = 30;
    private final int cost_xxxx1 = 500;
    private final int cost_xxx0 = 6000;
    private final int cost_xxxx0 = 30000;
    private final int cost_win = 40000;
    private final int cost_border = 0;
    private final int n;
    private final double cost[][];
    private int stoneColor;
    private final GobanPanel gobanPanel;

    public GomokuAlg(GobanPanel gobanPanel) {
    ...
    private double calcCost(int x, int y, int c) {
        ...
        do {
            ...
            i--;
        } while (c == gobanPanel.goban[i][j]);
        if ((x == 0) || (gobanPanel.goban[i][j] == (c == 2 ? 1 : 2))) {
            zakr_h++;
        }
        ...
        if ((x == n - 1) || (gobanPanel.goban[i][j] == (c == 2 ? 1 : 2))) {
            zakr_h++;
        }
        ...
        if ((y == 0) || (gobanPanel.goban[i][j] == (c == 2 ? 1 : 2))) {
            zakr_v++;
        }
        ...
        if ((y == n - 1) || (gobanPanel.goban[i][j] == (c == 2 ? 1 : 2))) {
            zakr_v++;
        }
        ...
        if ((y == 0) || (x == 0) || (gobanPanel.goban[i][j] == (c == 2 ? 1 : 2))) {
            zakr_dl++;
        }
        ...
        if ((y == n - 1) || (x == n - 1) || (gobanPanel.goban[i][j] == (c == 2 ? 1 : 2))) {
            zakr_dl++;
        }
        ...
        if ((y == n - 1) || (x == 0) || (gobanPanel.goban[i][j] == (c == 2 ? 1 : 2))) {
            zakr_dr++;
        }
        //вправо - вверх
        i = x;
        ...
        if ((y == 0) || (x == n - 1) || (gobanPanel.goban[i][j] == (c == 2 ? 1 : 2))) {
            zakr_dr++;
        }
    ...
    private int possibleFive(int x, int y, int c, int h) {
        ...
        if (h == 0) {
            ...
            do {
                ...
                i--;
            } while (length < 5 && gobanPanel.goban[i][j] != prot_c);
            i = x;
            j = y;
            do {
                length++;
